...
const imprimirProgramadoras = (programmers) => {
    for (const indice in programmers) {
      const programadora = programmers[indice];
      console.log(`${indice}: ${programadora.name} ${programadora.lastname}, su aporte fue ${programadora.knowledge}.`);
    }
  };

  imprimirProgramadoras(programmers);
...
const calcularAreaRectangulo = (alto, ancho) => ancho * alto;


console.log(`El area del rectangulo es de ${calcularAreaRectangulo(alto, ancho)}`)
